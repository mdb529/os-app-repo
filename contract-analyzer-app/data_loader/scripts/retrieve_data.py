    ...
    for num in data[0].split():
        ...
        for part in email_message.walk():
            ...
            if bool(email_attachment_name):
                ...
                filePath = os.path.join('/Users/MichaelButts/Desktop/workspace/django_project/drug_contract_analyzer/mhp_contracts/data_loader/raw_purchase_data/', fileName)
...
def loadData():
    ...
    fp = os.path.join(app_fp, 'raw_purchase_data/*')
    file_list = glob.glob(fp)
    output_file_name = 'preprocessed_os_purchases.xlsx'
    output_fp = os.path.join(app_fp, 'preprocessed_purchase_data/{0}'.format(output_file_name))
